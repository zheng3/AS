...
public class MapXadlParticipantLogic extends
		AbstractAutomapSingleAssemblyXArchRelativePathMappingLogic<BoxAssembly> {

	public MapXadlParticipantLogic(XArchFlatInterface xarch, ObjRef rootObjRef, String relativePath, ThingPropertyTrackingLogic tptl, IThing parentThing, Object kind){
