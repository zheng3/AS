...
import edu.uci.isr.bna4.logics.coordinating.AbstractMaintainThingsLogic;
...
public class MaintainXadlLinksLogic
	extends AbstractMaintainThingsLogic<IThing, IThing>{
	...
	public static final void updateThingIDByXArchID(XArchFlatQueryInterface xarch, ObjRef linkRef, Object propertyName, IThing targetThing){
		/*
		 * We cannot assume that the target is currently attached, so we parse
		 * the xArchID manually
		 */
		String xArchID = null;
		if(linkRef != null){
