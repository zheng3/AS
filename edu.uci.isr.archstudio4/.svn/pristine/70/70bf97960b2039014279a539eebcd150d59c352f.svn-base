...
AbstractAutomapSingleAssemblyXArchRelativePathMappingLogic<LabeledSplineAssembly>{
	...
	public MapXadlTransitionLogic(XArchFlatInterface xarch, ObjRef rootObjRef, String relativePath, ThingPropertyTrackingLogic tptl, IThing parentThing, Object kind){
		...
		automapXLinkToStuckPoint("fromState", "glass", IHasEndpoints.ENDPOINT_1_PROPERTY_NAME, true);
		automapXLinkToStuckPoint("toState", "glass", IHasEndpoints.ENDPOINT_2_PROPERTY_NAME, true);
	}
