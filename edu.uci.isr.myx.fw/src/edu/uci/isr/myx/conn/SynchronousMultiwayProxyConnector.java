...
public class SynchronousMultiwayProxyConnector extends AbstractMyxSimpleBrick implements IMyxDynamicBrick, InvocationHandler, IMultiwayResults{
	...
	protected List<IMultiwayProgressListener> progressListeners = 
		Collections.synchronizedList(new ArrayList<IMultiwayProgressListener>());
	...
	public Object invoke(Object proxy, Method method, Object[] args) throws Throwable{
		...
		synchronized(this){
			...
			for(Iterator it = trueServiceObjects.iterator(); it.hasNext(); ){
				Object trueServiceObject = it.next();
				try{
