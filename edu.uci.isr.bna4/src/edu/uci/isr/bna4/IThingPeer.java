...
public interface IThingPeer{
	...
	/**
	 * Draws the peer's associated Thing on the given GC,
	 * using the given CoordinateMapper to map all world coordinates
	 * to local coordinates if necessary.
	 * 
	 * @param view The view that sets the context for drawing the Thing
	 * @param g The GC on which to draw the Thing.
	 */
	 ...
	 * have hit this Thing?
	 * 
	 * @param view The view that sets the context for making the determination.
	 ...
	 * <code>null</code>.
	 * 
	 * @param g The GC context in which to make the determination.
