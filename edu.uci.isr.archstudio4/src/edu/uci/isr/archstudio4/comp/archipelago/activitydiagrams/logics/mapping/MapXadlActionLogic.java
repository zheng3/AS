...
public class MapXadlActionLogic
	extends
	AbstractAutomapSingleAssemblyXArchRelativePathMappingLogic<BoxAssembly>{

	public MapXadlActionLogic(XArchFlatInterface xarch, ObjRef rootObjRef, String relativePath, ThingPropertyTrackingLogic tptl, IThing parentThing, Object kind){
