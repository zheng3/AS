			...
			case BOTTOM:
				{
					...
					for(IThing t : things){
						if(t instanceof IHasBoundingBox){
							Rectangle boundingBox = ((IHasBoundingBox)t).getBoundingBox();
							if(boundingBox.y  + boundingBox.height > y) y = boundingBox.y + boundingBox.height;
						}
						else if(t instanceof IHasAnchorPoint){
							Point anchorPoint = ((IHasAnchorPoint)t).getAnchorPoint();
							if(anchorPoint.y > y) y = anchorPoint.y;
			...
			case LEFT:
				{
					...
					for(IThing t : things){
						if(t instanceof IHasBoundingBox){
							Rectangle boundingBox = ((IHasBoundingBox)t).getBoundingBox();
							if((boundingBox.x) < x) x = boundingBox.x;
						}
						else if(t instanceof IHasAnchorPoint){
							Point anchorPoint = ((IHasAnchorPoint)t).getAnchorPoint();
							if(anchorPoint.y < x) x = anchorPoint.x;
						}
					}
					for(IThing t : things){
						if(t instanceof IHasMutableBoundingBox){
			...
			case RIGHT:
				{
					...
					for(IThing t : things){
						if(t instanceof IHasBoundingBox){
							Rectangle boundingBox = ((IHasBoundingBox)t).getBoundingBox();
							if(boundingBox.x  + boundingBox.width > x) x = boundingBox.x + boundingBox.width;
						}
						else if(t instanceof IHasAnchorPoint){
							Point anchorPoint = ((IHasAnchorPoint)t).getAnchorPoint();
							if(anchorPoint.x > x) x = anchorPoint.x;
						}
					}
					for(IThing t : things){
						if(t instanceof IHasMutableBoundingBox){
