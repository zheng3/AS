...
public class LJMExample{
	...
	public static void main(String[] args) throws IOException{
		 ...
		 */
		IExampleInterface deployedObject = (IExampleInterface)LJMProxyFactory.createProxy("localhost", server.getPort(), "ANameForTheDeployedObject", new Class[]{IExampleInterface.class});
