...
import edu.uci.isr.archstudio4.comp.copypaste.ObjRefNode;
import edu.uci.isr.archstudio4.comp.copypaste.RelatedElementNode;
		...
		if(nodes != null && nodes.length > 0) {
			for(ICopiedElementNode node : nodes) {
				...
				if(children != null && children.size() > 0) {
					setCheckedForRequiredNodes(children.toArray(new ICopiedElementNode[children.size()]),newParentChecked);
				}				
			}
		}
	}
