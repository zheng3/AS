...
public class PointHintSynchronizer
	...
	public PointHintSynchronizer(String hintSuffix, Class<? extends IThing> thingInterface, String propertyName, String... userProperties){
		...
		this.moveWithThingIdPropertyName = MoveWithLogic.MOVES_WITH_THING_ID_PROPERTY_NAME;
	...
	@Override
	public void filteredThingChanged(IHintRepository repository, Object context, String partPath, String[] parts, IThing thing, Object propertyName, Object oldValue, Object newValue){
		try{
