...
public class MyxRemoteRuntime extends MyxBasicRuntime{
	...
	public static void main(String[] args) throws IOException{
		...
		IMyxRuntimeRegistry myxRegistry = (IMyxRuntimeRegistry)LJMProxyFactory.createProxy(registryHost, registryPort, registryName, new Class[]{IMyxRuntimeRegistry.class});
