...
public class StatechartsTreeContentProvider implements IArchipelagoTreeContentProvider{
	protected static final String FOLDER_NODE_TYPE = "STATECHARTS";
	protected FolderNode structureFolderNode = null;
	
	protected ArchipelagoServices AS = null;
	protected ObjRef xArchRef = null;
	
	public StatechartsTreeContentProvider(ArchipelagoServices services, ObjRef xArchRef){
		this.AS = services;
	...
	public Object[] getChildren(Object parentElement, Object[] childrenFromPreviousProvider){
		if(isRootElement(parentElement)){
			if(structureFolderNode == null){
				structureFolderNode = new FolderNode((ObjRef)parentElement, FOLDER_NODE_TYPE, "Statecharts");
			}
